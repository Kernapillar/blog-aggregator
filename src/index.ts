import { CommandRegistry, registerCommand, handlerLogin, runCommand, handlerRegister, handlerGetUsers, handlerClearUsers, handlerAgg, handlerAddFeed} from "./commands";
